...
function EntityNodeComponent({ data, selected }: NodeProps<EntityNodeType>) {
  ...
  return (
    <div className={cls}>
      ...
      <Handle type="target" position={Position.Top} id="tt" className="er-handle" />
      <Handle type="source" position={Position.Top} id="st" className="er-handle" />
      <Handle type="target" position={Position.Bottom} id="tb" className="er-handle" />
      <Handle type="source" position={Position.Bottom} id="sb" className="er-handle" />
