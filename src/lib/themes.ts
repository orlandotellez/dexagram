export type ThemeId = "luna" | "dark" | "midnight" | "slate" | "emerald" | "ocean" | "noir" | "blanco";
...
export const THEMES: ThemeMeta[] = [
  ...
  { id: "noir", label: "Noir", swatch: "#ffffff", bg: "#000000" },
  { id: "blanco", label: "Blanco", swatch: "#000000", bg: "#ffffff" },
];
